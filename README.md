...
5.4 Visualized PCA and ADMIXTURE and check for differences in Cladocopium genotypes between _Acropora_ taxa with Cladocopium.ipynb. This ouptuts **Figure 5**, **Supplemental Table 1**, and **Supplemental Table 3**. \
