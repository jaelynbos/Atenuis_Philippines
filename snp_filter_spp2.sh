...
#SBATCH -o vcf_filt_spp2-%A_%a.out
...
#Step 11: Filter SNPs missing in >30% of individuals
...
#Step 21: Filter individuals with >75% missing data
...
#Step 22:  Filter SNPs missing in >15% of individuals
vcftools --vcf snps17.recode.vcf --max-missing 0.85 --recode --recode-INFO-all --out snps18

#Step 23: Filter out loci with top 2% of mean depths
...
#Step 24: Filter individuals with >50% missing data
