...
#FAKE STEP1
vcftools --vcf snps1.recode.vcf --missing-indv --out snps1
awk 'NR >1 && $5 > 0.900 {print $1}' snps1.imiss > snps1_imiss_900
vcftools --vcf snps1.recode.vcf --remove snps1_imiss_900 --recode --recode-INFO-all --out snps2
...
#Step 6: Filter individuals with >95% missing data
#vcftools --vcf snps5.recode.vcf --missing-indv --out snps5
#awk 'NR >1 && $5 > 0.95 {print $1}' snps5.imiss > snps5_imiss_950
#vcftools --vcf snps5.recode.vcf --remove snps5_imiss_950 --recode --recode-INFO-all --out snps6
...
#Step 8: Filter individuals with >90% missing data
#vcftools --vcf snps7.recode.vcf --missing-indv --out snps7
#awk 'NR >1 && $5 > 0.90 {print $1}' snps7.imiss > snps7_imiss_900
#vcftools --vcf snps7.recode.vcf --remove snps7_imiss_900 --recode --recode-INFO-all --out snps8

#Step 9: Filter SNPs missing in >30% of individuals
#vcftools --vcf snps8.recode.vcf --max-missing 0.70 --recode --recode-INFO-all --out snps9

#Step 10: Filter individuals with >85% missing data
#vcftools --vcf snps9.recode.vcf --missing-indv --out snps9
#awk 'NR >1 && $5 > 0.85 {print $1}' snps9.imiss > snps9_imiss_850
#vcftools --vcf snps9.recode.vcf --remove snps9_imiss_850 --recode --recode-INFO-all --out snps10

#Step 11: Filter SNPs missing in >25% of individuals
#vcftools --vcf snps10.recode.vcf --max-missing 0.75 --recode --recode-INFO-all --out snps11

#Step 12: Filter individuals with >75% missing data
...
#Step 13: Filter SNPs missing in >20% of individuals
#vcftools --vcf snps12.recode.vcf --max-missing 0.8 --recode --recode-INFO-all --out snps13

#Step 14: Filter individuals with >75% missing data
...
#Step 20: high quality depth filter
...
#Step 21: Filter individuals with >70% missing data
#vcftools --vcf highqd.recode.vcf --missing-indv --out snps16
#awk 'NR >1 && $5 > 0.70 {print $1}' snps16.imiss > snps16_imiss_700
vcftools --vcf highqd.recode.vcf --remove snps16_imiss_700 --recode --recode-INFO-all --out snps17

#Step 22:  Filter SNPs missing in >20% of individuals
vcftools --vcf snps17.recode.vcf --max-missing 0.80 --recode --recode-INFO-all --out snps18

#Step 23:  Filter SNPs missing in >15% of individuals
vcftools --vcf snps18.recode.vcf --max-missing 0.85 --recode --recode-INFO-all --out snps19

#Step 24: Filter individuals with >70% missing data
#vcftools --vcf snps19.recode.vcf --missing-indv --out snps20
#awk 'NR >1 && $5 > 0.70 {print $1}' snps20.imiss > snps20_imiss_700
#vcftools --vcf snps19.recode.vcf --remove snps20_imiss_700 --recode --recode-INFO-all --out snps20

#Step 25: Filter out loci with top 2% of mean depths
#vcftools --vcf snps20.recode.vcf --out filt_depth --depth
#vcftools --vcf snps20.recode.vcf --out filt_depth --site-mean-depth
#vcftools --vcf snps20.recode.vcf --out filt_depth --geno-depth

#python depth_lastfilt.py
#vcftools --vcf snps20.recode.vcf --exclude-positions highdp2.txt --recode --recode-INFO-all --out snps_filtered_depth

#Step 26: Filter individuals with >50% missing data
#vcftools --vcf snps_filtered_depth.recode.vcf --missing-indv --out snps21
#awk 'NR >1 && $5 > 0.5 {print $1}' snps21.imiss > snps21_imiss_500
#vcftools --vcf snps_filtered_depth.recode.vcf --remove snps21_imiss_500 --recode --recode-INFO-all --out snps21
#pwd

#Step 24: Filter individuals with >25% missing data
#vcftools --vcf snps19.recode.vcf --missing-indv --out snps20
#awk 'NR >1 && $5 > 0.1 {print $1}' snps20.imiss > snps20_imiss_100
#vcftools --vcf snps19.recode.vcf --remove snps20_imiss_100 --recode --recode-INFO-all --out snps20