...
write.csv(taxa13,'acropora13_fst_boot.csv')

taxa14<-fst_bootstrap(1,4,gi,1000)
write.csv(taxa14,'acropora14_fst_boot.csv')

taxa23<-fst_bootstrap(2,3,gi,1000)
write.csv(taxa23,'acropora23_fst_boot.csv')

taxa24<-fst_bootstrap(2,4,gi,1000)
write.csv(taxa24,'acropora24_fst_boot.csv')

taxa34<-fst_bootstrap(3,4,gi,1000)
write.csv(taxa34,'acropora34_fst_boot.csv')





#Bootstrap FSTs between Cladocopium in different Acropora taxa


setwd("/scratch/jbos/cladocopium")
